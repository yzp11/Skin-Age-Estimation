...
def get_Wrinkle_vector(face_image_path):
    ...
    for k, d in enumerate(dets):
        ...
        for i in range(4):
            ...
            result.append(face_wrinkle(cropped_image,theta=theta[i]))
...
if __name__ == '__main__':
    ...
    image_path = "C:/Users/wry/Desktop/123.jpg"
    ################ 0检测横向皱纹   math.pi/2检测竖向皱纹    math.pi/4 | math.pi/4*3 检测斜向皱纹
    result=get_Wrinkle_vector(image_path)
    # img=cv2.imread(image_path)
    # result=face_wrinkle(img)
    print(result)
